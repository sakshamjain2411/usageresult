...
function(e) {
    ...
    module.exports = e) : "function" == typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function(t) {
        return e(t),
        e.Highcharts = t,
        e
    ...
    var t = e ? e._modules : {};
    function n(t, n, i, o) {
        t.hasOwnProperty(n) || (t[n] = o.apply(null, i),
        "function" == typeof CustomEvent && e.win.dispatchEvent(new CustomEvent("HighchartsModuleLoaded",{
            detail: {
                path: n,
                module: t[n]
            }
    ...
    n(t, "Core/Chart/ChartNavigationComposition.js", [], function() {
        ...
        return function(e) {
            e.compose = function(e) {
                return e.navigation || (e.navigation = new t(e)),
                e
            }
            ;
            class t {
    ...
    n(t, "Extensions/Exporting/Fullscreen.js", [t["Core/Renderer/HTML/AST.js"], t["Core/Globals.js"], t["Core/Utilities.js"]], function(e, t, n) {
        let {composed: i} = t
          , {addEvent: o, fireEvent: r, pushUnique: s} = n;
        function l() {
        ...
        class a {
            ...
            close() {
                ...
                r(t, "fullscreenClose", null, function() {
                    ...
                    e.unbindFullscreenEvent && (e.unbindFullscreenEvent = e.unbindFullscreenEvent()),
            ...
            open() {
                ...
                r(t, "fullscreenOpen", null, function() {
                    if (n && (e.origWidthOption = n.width,
    ...
    n(t, "Core/HttpUtilities.js", [t["Core/Globals.js"], t["Core/Utilities.js"]], function(e, t) {
        let {win: n} = e
          , {discardElement: i, objectEach: o} = t
          , r = {
            ajax: function(e) {
                let t = {
                ...
                e.headers && e.headers["Content-Type"] || n.setRequestHeader("Content-Type", t[e.dataType || "json"] || t.text),
                ...
                n.onreadystatechange = function() {
                    ...
                    if (4 === n.readyState) {
                        if (200 === n.status) {
                            if ("blob" !== e.responseType && (t = n.responseText,
                            "json" === e.dataType))
                                try {
                                    t = JSON.parse(t)
                                } catch (e) {
                ...
                ,
                e.data && "string" != typeof e.data && (e.data = JSON.stringify(e.data)),
                n.send(e.data)
            },
    ...
    n(t, "Extensions/Exporting/Exporting.js", [t["Core/Renderer/HTML/AST.js"], t["Core/Chart/Chart.js"], t["Core/Chart/ChartNavigationComposition.js"], t["Core/Defaults.js"], t["Extensions/Exporting/ExportingDefaults.js"], t["Extensions/Exporting/ExportingSymbols.js"], t["Extensions/Exporting/Fullscreen.js"], t["Core/Globals.js"], t["Core/HttpUtilities.js"], t["Core/Utilities.js"]], function(e, t, n, i, o, r, s, l, a, c) {
        var p;
        let {defaultOptions: u} = i
          , {doc: h, SVG_NS: d, win: g} = l
          , {addEvent: f, css: m, createElement: x, discardElement: y, extend: b, find: v, fireEvent: w, isObject: E, merge: C, objectEach: S, pick: F, removeEvent: T, uniqueKey: O} = c;
        return function(t) {
            let i;
            let p = [/-/, /^(clipPath|cssText|d|height|width)$/, /^font$/, /[lL]ogical(Width|Height)$/, /^parentRule$/, /^(cssRules|ownerRules)$/, /perspective/, /TapHighlightColor/, /^transition/, /^length$/, /^\d+$/]
            ...
            function k(e) {
                ...
                : l && (n = function(e) {
                    e && e.stopPropagation(),
                    i.contextMenu(p.menuClassName, l, p.translateX || 0, p.translateY || 0, p.width || 0, p.height || 0, p),
                    p.setState(2)
                }
                ),
                ...
                let p = o.button(r.text, 0, 0, n, c, void 0, void 0, void 0, void 0, r.useHTML).addClass(e.className).attr({
                    title: F(i.options.lang[r._titleKey || r.titleKey], "")
                });
                p.menuClassName = e.menuClassName || "highcharts-menu-" + i.btnCount++,
                r.symbol && (t = o.symbol(r.symbol, Math.round((r.symbolX || 0) - a / 2), Math.round((r.symbolY || 0) - a / 2), a, a, {
                    width: a,
                    height: a
                ...
                p.add(i.exportingGroup).align(b(r, {
                    width: p.width,
                    x: F(r.x, i.buttonOffset)
                }), !0, "spacingBox"),
                i.buttonOffset += ((p.width || 0) + r.buttonSpacing) * ("right" === r.align ? -1 : 1),
            ...
            function N() {
                ...
                w(this, "beforePrint"),
                t && this.chartWidth > t && (n.resetParams = [this.options.chart.width, void 0, !1],
                this.setSize(t, void 0, !1)),
                [].forEach.call(n.childNodes, function(e, t) {
                    1 === e.nodeType && (n.origDisplay[t] = e.style.display,
            ...
            function j(e) {
                ...
                f(e, "destroy", e.destroyExport)
            }
            function G(t, n, i, o, r, s, l) {
                let a = this, p = a.options.navigation, u = a.chartWidth, d = a.chartHeight, y = "cache-" + t, v = Math.max(r, s), C, S = a[y];
                S || (a.exportContextMenu = a[y] = S = x("div", {
                    ...
                    pointerEvents: "auto",
                    ...a.renderer.style
                }, a.scrollablePlotArea?.fixedDiv || a.container),
                C = x("ul", {
                ...
                n.forEach(function(t) {
                    if ("string" == typeof t && (t = a.options.exporting.menuItemDefinitions[t]),
                    E(t, !0)) {
                        let n;
                        t.separator ? n = x("hr", void 0, void 0, C) : ("viewData" === t.textKey && a.isDataTableVisible && (t.textKey = "hideData"),
                        n = x("li", {
                            className: "highcharts-menu-item",
                            onclick: function(e) {
                                e && e.stopPropagation(),
                                S.hideMenu(),
                                "string" != typeof t && t.onclick && t.onclick.apply(a, arguments)
                            }
                        }, void 0, C),
                        e.setElementHTML(n, t.text || a.options.lang[t.textKey]),
                        a.styledMode || (n.onmouseover = function() {
                            m(this, p.menuItemHoverStyle)
                        }
                        ,
                        n.onmouseout = function() {
                            m(this, p.menuItemStyle)
                        }
                        ,
                        m(n, b({
                            cursor: "pointer"
                ...
                a.exportDivElements.push(C, S),
                a.exportMenuWidth = S.offsetWidth,
                a.exportMenuHeight = S.offsetHeight);
                let F = {
                    display: "block"
                };
                i + (a.exportMenuWidth || 0) > u ? F.right = u - i - r - v + "px" : F.left = i - v + "px",
                o + s + (a.exportMenuHeight || 0) > d && l.alignOptions?.verticalAlign !== "top" ? F.bottom = d - o - v + "px" : F.top = o + s - v + "px",
                m(S, F),
                m(a.renderTo, {
                    overflow: ""
                }),
            ...
            function D(e) {
                ...
                i.length = 0),
                n.exportingGroup && (n.exportingGroup.destroy(),
                delete n.exportingGroup),
                o && (o.forEach(function(e, t) {
                    e && (c.clearTimeout(e.hideTimer),
                    T(e, "mouseleave"),
                    o[t] = e.onmouseout = e.onmouseover = e.ontouchstart = e.onclick = null,
                    y(e))
                }),
                o.length = 0),
            ...
            function W() {
                return this.styledMode && this.inlineStyles(),
                this.container.innerHTML
            }
            function R() {
                let e = this.userOptions.title && this.userOptions.title.text
                  , t = this.options.exporting.filename;
                return t ? t.replace(/\//g, "-") : ("string" == typeof e && (t = e.toLowerCase().replace(/<\/?[^>]+(>|$)/g, "").replace(/[\s_]+/g, "-").replace(/[^a-z\d\-]/g, "").replace(/^[\-]+/g, "").replace(/[\-]+/g, "-").substr(0, 24).replace(/[\-]+$/g, "")),
                (!t || t.length < 5) && (t = "chart"),
                t)
            }
            function L(e) {
                let t, n, i = C(this.options, e);
                i.plotOptions = C(this.userOptions.plotOptions, e && e.plotOptions),
                i.time = C(this.userOptions.time, e && e.time);
                let o = x("div", null, {
                    position: "absolute",
                    top: "-9999em",
                ...
                this.axes.forEach(function(e) {
                    e.userOptions.internalKey || (e.userOptions.internalKey = O()),
                    e.options.isInternal || (c[e.coll] || (c[e.coll] = !0,
                    i[e.coll] = []),
                    i[e.coll].push(C(e.userOptions, {
                        visible: e.visible
                    })))
                }),
            ...
            function q() {
                ...
                r && r.body.appendChild(r.createElementNS(d, "svg")),
                function t(o) {
                    let s, a, c, u, h, d;
                    let f = {};
                    if (r && 1 === o.nodeType && -1 === P.indexOf(o.nodeName)) {
                        if (s = g.getComputedStyle(o, null),
                        a = "svg" === o.nodeName ? {} : g.getComputedStyle(o.parentNode, null),
                        !i[o.nodeName]) {
                            ...
                            let t = g.getComputedStyle(c, null)
                              , n = {};
                            for (let e in t)
                                e.length < 1e3 && "string" == typeof t[e] && !/^\d+$/.test(e) && (n[e] = t[e]);
                            i[o.nodeName] = n,
                            "text" === o.nodeName && delete i.text.fill,
                            e.removeChild(c)
                        }
                        for (let e in s)
                            (l.isFirefox || l.isMS || l.isSafari || Object.hasOwnProperty.call(s, e)) && function(e, t) {
                                if (u = h = !1,
                                n.length) {
                                    for (d = n.length; d-- && !h; )
                                        h = n[d].test(t);
                                ...
                                for ("transform" === t && "none" === e && (u = !0),
                                d = p.length; d-- && !u; ) {
                                    if (t.length > 1e3)
                                        throw Error("Input too long");
                                    u = p[d].test(t) || "function" == typeof e
                                }
                                !u && (a[t] !== e || "svg" === o.nodeName) && i[o.nodeName][t] !== e && (M && -1 === M.indexOf(t) ? f[t] = e : e && o.setAttribute(t.replace(/[A-Z]/g, function(e) {
            ...
            function U(e, t) {
                let n = e.indexOf("</svg>") + 6
                  , i = e.substr(n);
                return e = e.substr(0, n),
                t && t.exporting && t.exporting.allowHTML && i && (i = '<foreignObject x="0" y="0" width="' + t.chart.width + '" height="' + t.chart.height + '"><body xmlns="http://www.w3.org/1999/xhtml">' + i.replace(/(<(?:img|br).*?(?=\>))>/g, "$1 />") + "</body></foreignObject>",
                e = e.replace("</svg>", i + "</svg>")),
                e = e.replace(/zIndex="[^"]+"/g, "").replace(/symbolName="[^"]+"/g, "").replace(/jQuery\d+="[^"]+"/g, "").replace(/url\(("|&quot;)(.*?)("|&quot;)\;?\)/g, "url($2)").replace(/url\([^#]+#/g, "url(#").replace(/<svg /, '<svg xmlns:xlink="http://www.w3.org/1999/xlink" ').replace(/ (NS\d+\:)?href=/g, " xlink:href=").replace(/\n+/g, " ").replace(/(fill|stroke)="rgba\(([ \d]+,[ \d]+,[ \d]+),([ \d\.]+)\)"/g, '$1="rgb($2)" $1-opacity="$3"').replace(/&nbsp;/g, "\xa0").replace(/&shy;/g, "\xad")
            }
            t.compose = function(e, t) {
                r.compose(t),
                s.compose(e);
                let n = e.prototype;
                n.exportChart || (n.afterPrint = H,
                n.exportChart = I,
                n.inlineStyles = q,
                n.print = A,
                n.sanitizeSVG = U,
                ...
                n.callbacks.push(j),
                f(e, "init", V),
                l.isSafari && g.matchMedia("print").addListener(function(e) {
                    i && (e.matches ? i.beforePrint() : i.afterPrint())
                }),
                u.exporting = C(o.exporting, u.exporting),
                u.lang = C(o.lang, u.lang),
                u.navigation = C(o.navigation, u.navigation))
            }
        }(p || (p = {})),
        p
    }),
    n(t, "masters/modules/exporting.src.js", [t["Core/Globals.js"], t["Extensions/Exporting/Exporting.js"], t["Core/HttpUtilities.js"]], function(e, t, n) {
        return e.HttpUtilities = e.HttpUtilities || n,
        e.ajax = e.HttpUtilities.ajax,
        e.getJSON = e.HttpUtilities.getJSON,
        e.post = e.HttpUtilities.post,
